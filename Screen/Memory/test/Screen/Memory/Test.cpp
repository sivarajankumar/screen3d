...
namespace Screen {
	namespace Memory {
		...
		void Test::testGarbage(){
			...
			buf2.setAt(SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,2),&magic,sizeof(unsigned long));
			buf2.setAt(SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,3),&magic,sizeof(unsigned long));
			buf2.setAt(SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,4),&magic,sizeof(unsigned long));
			buf2.setAt(SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,5),&magic,sizeof(unsigned long));
			buf2.setAt(SCREEN_MEMORY_DEFAULT_MAX_SIZE,&magic,sizeof(unsigned long));
			buf2.setAt(SCREEN_MEMORY_DEFAULT_MAX_SIZE*SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,&magic,sizeof(unsigned long));

			unsigned int value = SCREEN_MEMORY_DEFAULT_MIN_SIZE+
				SCREEN_MEMORY_DEFAULT_MIN_SIZE*SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER+
				SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,2)+
				SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,3)+
				SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,4)+
				SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,5)+
				SCREEN_MEMORY_DEFAULT_MIN_SIZE*std::pow(SCREEN_MEMORY_DEFAULT_SIZE_MULTIPLIER,6);
